...
namespace HeightmapProcessor {
    ...
    public class HeightMapInfoWriter : ContentTypeWriter<HeightMapInfoContent> {
        protected override void Write(ContentWriter output, HeightMapInfoContent value) {
            ...
            foreach (float height in value.Height) output.Write(height);
        }
        ...
        public override string GetRuntimeType(TargetPlatform targetPlatform) {
            return "JiggleGame.HeightMapInfo, " + "JiggleGame, Version=1.0.0.0, Culture=neutral";
        }
        ...
        public override string GetRuntimeReader(TargetPlatform targetPlatform) {
            return "JiggleGame.HeightMapInfoReader, " + "JigLibGame, Version=1.0.0.0, Culture=neutral";
        }
    }
}