...
namespace JigLibGame.PhysicObjects
{
    public class RagdollObject : PhysicObject
    {
        ...
        public RagdollObject(Game game, Model capsule, Model sphere, Model box, RagdollType type, float density) : base(game)
        {
            ...
            limbs[(int) LimbId.Head] = new SphereObject(Game, sphere, 0.15f, Matrix.Identity, Vector3.Zero);
            limbs[(int) LimbId.UpperLegLeft] = new CapsuleObject(Game, capsule, 0.08f, 0.3f, Matrix.CreateRotationX(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int) LimbId.UpperLegRight] = new CapsuleObject(Game, capsule, 0.08f, 0.3f, Matrix.CreateRotationX(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int) LimbId.LowerLegLeft] = new CapsuleObject(Game, capsule, 0.08f, 0.3f, Matrix.CreateRotationX(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int) LimbId.LowerLegRight] = new CapsuleObject(Game, capsule, 0.08f, 0.3f, Matrix.CreateRotationX(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int) LimbId.UpperArmLeft] = new CapsuleObject(Game, capsule, 0.07f, 0.2f, Matrix.CreateRotationZ(MathHelper.ToRadians(90)), Vector3.Zero);
            limbs[(int) LimbId.UpperArmRight] = new CapsuleObject(Game, capsule, 0.07f, 0.2f, Matrix.CreateRotationZ(MathHelper.ToRadians(90)), Vector3.Zero);
            ...
            if (type == RagdollType.Complex)
            {
                ...
                joints[(int) JointId.ShoulderLeft].Initialise(limbs[(int) LimbId.Torso].PhysicsBody, limbs[(int) LimbId.UpperArmLeft].PhysicsBody, new Vector3(1.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.05f, 0.15f), haldWidth, 70.0f, 30.0f, 0.7f, damping);

                joints[(int) JointId.ShoulderRight].Initialise(limbs[(int) LimbId.Torso].PhysicsBody, limbs[(int) LimbId.UpperArmRight].PhysicsBody, new Vector3(1.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.05f, -0.15f), haldWidth, 30.0f, 75.0f, 0.7f, damping);

                joints[(int) JointId.HipLeft].Initialise(limbs[(int) LimbId.Hips].PhysicsBody, limbs[(int) LimbId.UpperLegLeft].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, -0.25f, 0.12f), haldWidth, 10.0f, 60.0f, 0.4f, damping);

                joints[(int) JointId.HipRight].Initialise(limbs[(int) LimbId.Hips].PhysicsBody, limbs[(int) LimbId.UpperLegRight].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, -0.25f, -0.12f), haldWidth, 10.0f, 60.0f, 0.4f, damping);

                joints[(int) JointId.AnkleLeft].Initialise(limbs[(int) LimbId.LowerLegLeft].PhysicsBody, limbs[(int) LimbId.FootLeft].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, -0.15f, 0.15f), haldWidth, 30.0f, 10.0f, 0.01f, damping);

                joints[(int) JointId.AnkleRight].Initialise(limbs[(int) LimbId.LowerLegRight].PhysicsBody, limbs[(int) LimbId.FootRight].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, -0.15f, -0.15f), haldWidth, 30.0f, 10.0f, 0.01f, damping);
            ...
            else
            {
                ...
                joints[(int) JointId.ShoulderRight].Initialise(limbs[(int) LimbId.Torso].PhysicsBody, limbs[(int) LimbId.UpperArmRight].PhysicsBody, new Vector3(1.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.25f, -0.15f), haldWidth, 75.0f, 30.0f, 0.7f, damping);


                joints[(int) JointId.HipLeft].Initialise(limbs[(int) LimbId.Torso].PhysicsBody, limbs[(int) LimbId.UpperLegLeft].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, -0.25f, 0.12f), haldWidth, 10.0f, 60.0f, 0.4f, damping);


                joints[(int) JointId.HipRight].Initialise(limbs[(int) LimbId.Torso].PhysicsBody, limbs[(int) LimbId.UpperLegRight].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, -0.25f, -0.12f), haldWidth, 10.0f, 60.0f, 0.4f, damping);
            }


            joints[(int) JointId.KneeLeft].Initialise(limbs[(int) LimbId.UpperLegLeft].PhysicsBody, limbs[(int) LimbId.LowerLegLeft].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, -0.15f, 0.0f), haldWidth, 100.0f, 0.0f, sidewaysSlack, damping);

            joints[(int) JointId.KneeRight].Initialise(limbs[(int) LimbId.UpperLegRight].PhysicsBody, limbs[(int) LimbId.LowerLegRight].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, -0.15f, 0.0f), haldWidth, 100.0f, 0.0f, sidewaysSlack, damping);

            joints[(int) JointId.ElbowLeft].Initialise(limbs[(int) LimbId.UpperArmLeft].PhysicsBody, limbs[(int) LimbId.LowerArmLeft].PhysicsBody, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, 0.0f, 0.13f), haldWidth, 0.0f, 130.0f, sidewaysSlack, damping);
