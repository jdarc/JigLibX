...
namespace JiggleGame {
    ...
    public class HeightMapInfo {
        ...
        public float GetHeight(Vector3 position) {
            ...
            float topHeight = MathHelper.Lerp(heights[left, top], heights[left + 1, top], xNormalized);

            float bottomHeight = MathHelper.Lerp(heights[left, top + 1], heights[left + 1, top + 1], xNormalized);
