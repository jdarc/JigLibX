...
namespace JigLibX.Collision {
    ...
    public class CollisionInfo {
        ...
        static CollisionInfo() {
            ...
            for (int i = 0; i < InitialCollisionInfoStack; ++i) freeInfos.Push(new CollisionInfo());
            for (int i = 0; i < InitialCollisionPointInfoStack; ++i) freePtInfos.Push(new CollPointInfo());
        }
        ...
        private unsafe void Init(CollDetectInfo info, Vector3 dirToBody0, SmallCollPointInfo* pointInfos, int numPointInfos) {
            ...
            } else { MatPairProperties = matTable.GetPairProperties(ID0, ID1); }
        ...
        private void Destroy() {
            for (int i = 0; i < NumCollPts; ++i) freePtInfos.Push(PointInfo[i]);
            SkinInfo.Skin0 = null;
            SkinInfo.Skin1 = null;
        }
