...
namespace JigLibX.Collision {
    ...
    public class CollisionSkin {
        ...
        public int AddPrimitive(Primitive prim, int matID) {
            if (matID == (int) MaterialTable.MaterialID.UserDefined) throw new ArgumentException("matID can't be set to 'UserDefined'");
        ...
        public float GetVolume() {
            float result = 0.0f;
            for (int prim = primitivesLocal.Count; prim-- != 0;) result += primitivesLocal[prim].GetVolume();
            return result;
        }
        ...
        public float GetSurfaceArea() {
            float result = 0.0f;
            for (int prim = primitivesLocal.Count; prim-- != 0;) result += primitivesLocal[prim].GetSurfaceArea();
            return result;
        }
        ...
        public void SetNewTransform(ref Transform transform) {
            ...
            if (collSystem != null) collSystem.CollisionSkinMoved(this);
        }
        ...
        public void UpdateWorldBoundingBox() {
            ...
            for (int iold = primitivesOldWorld.Count; iold-- != 0;) BoundingBoxHelper.AddPrimitive(primitivesOldWorld[iold], ref temp);
        ...
        public CollisionSystem CollisionSystem {
            set { collSystem = value; }
            get { return collSystem; }
        }
        ...
        public void GetMassProperties(PrimitiveProperties primitiveProperties, out float mass, out Vector3 centerOfMass, out Matrix inertiaTensor, out Matrix inertiaTensorCoM) {
            ...
            if (primitiveProperties.MassType == PrimitiveProperties.MassTypeEnum.Mass) mass = primitiveProperties.MassOrDensity;
        }
