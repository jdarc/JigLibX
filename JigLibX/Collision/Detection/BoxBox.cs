...
namespace JigLibX.Collision.Detection {
    ...
    public class CollDetectBoxBox : DetectFunctor {
        ...
        /// </summary>
        public CollDetectBoxBox() : base("BoxBox", (int) PrimitiveType.Box, (int) PrimitiveType.Box) { }
        ...
        /// <param name="combinationDistanceSq"></param>
        /// <returns>int</returns>
        private static unsafe int GetAABox2BoxEdgesIntersectionPoints(List<ContactPoint> pts, ref Vector3 sides, Box box, ref Matrix origBoxOrient, ref Vector3 origBoxPos, float combinationDistanceSq) {
            int num = 0;
            Vector3[] boxPts;
        ...
        public override void CollDetect(CollDetectInfo info, float collTolerance, CollisionFunctor collisionFunctor) {
            ...
            if (Disjoint(out testDepth, ref box0_Right, box0, box1, collTolerance)) return;
            ...
            if (depth > -JiggleMath.Epsilon) GetBoxBoxIntersectionPoints(contactPts, oldBox0, oldBox1, combinationDist, collTolerance);
