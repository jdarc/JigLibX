...
namespace JigLibX.Collision.Detection {
    ...
    public class CollDetectCapsulePlane : DetectFunctor {
        ...
        /// </summary>
        public CollDetectCapsulePlane() : base("CapsulePlane", (int) PrimitiveType.Capsule, (int) PrimitiveType.Plane) { }
        ...
        public override void CollDetect(CollDetectInfo info, float collTolerance, CollisionFunctor collisionFunctor) {
            ...
            Plane oldPlane = (Plane) info.Skin1.GetPrimitiveOldWorld(info.IndexPrim1);
            Plane newPlane = (Plane) info.Skin1.GetPrimitiveNewWorld(info.IndexPrim1);
            ...
            unsafe {
...
#endif
                {
                    ...
                    // the end
                    {
                        ...
                        if (numCollPts > 0) collisionFunctor.CollisionNotify(ref info, ref oldPlane.normal, collPts, numCollPts);
                    }
                }
#if !USE_STACKALLOC
