...
namespace JigLibX.Collision.Detection {
    ...
    public class CollDetectSpherePlane : DetectFunctor {
        ...
        /// Constructor
        /// </summary>
        public CollDetectSpherePlane() : base("SpherePlane", (int) PrimitiveType.Sphere, (int) PrimitiveType.Plane) { }
        ...
        public override void CollDetect(CollDetectInfo info, float collTolerance, CollisionFunctor collisionFunctor) {
            ...
            Plane oldPlane = info.Skin1.GetPrimitiveOldWorld(info.IndexPrim1) as Plane;
            Plane newPlane = info.Skin1.GetPrimitiveNewWorld(info.IndexPrim1) as Plane;
