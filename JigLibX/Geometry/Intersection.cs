...
namespace JigLibX.Geometry {
    ...
    public sealed class Intersection {
        ...
        public static bool SegmentCapsuleIntersection(out float tS, Segment seg, Capsule capsule) {
            ...
            if (!SegmentInfiniteCylinderIntersection(out sideFrac, seg, new Segment(capsule.Position, capsule.Orientation.Backward), capsule.Radius)) return false; // check this
            ...
            else if (Vector3.Dot(sidePos - capsule.GetEnd(), capsule.Orientation.Backward) > 0.0f) sideFrac = float.MaxValue;
