...
namespace JigLibX.Geometry {
    ...
    public sealed class Distance {
        ...
        public static float SqrDistance(Vector3 point, Box box, out float pfBParam0, out float pfBParam1, out float pfBParam2) {
            ...
            Vector3 kClosest = new Vector3(Vector3.Dot(kDiff, box.Orientation.Right), Vector3.Dot(kDiff, box.Orientation.Up), Vector3.Dot(kDiff, box.Orientation.Backward));
        ...
        public static float SqrDistance(Line line, Box box, out float pfLParam, out float pfBParam0, out float pfBParam1, out float pfBParam2) {
            ...
            Vector3 pnt = new Vector3(Vector3.Dot(diff, box.Orientation.Right), Vector3.Dot(diff, box.Orientation.Up), Vector3.Dot(diff, box.Orientation.Backward));
            Vector3 kDir = new Vector3(Vector3.Dot(line.Dir, box.Orientation.Right), Vector3.Dot(line.Dir, box.Orientation.Up), Vector3.Dot(line.Dir, box.Orientation.Backward));
