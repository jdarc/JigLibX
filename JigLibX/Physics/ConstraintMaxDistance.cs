...
namespace JigLibX.Physics {
    ...
    public class ConstraintMaxDistance : Constraint {
        ...
        public override bool Apply(float dt) {
            ...
            if (clampedRelPos0Mag > mMaxDistance) Vector3.Multiply(ref clampedRelPos0, mMaxDistance / clampedRelPos0Mag, out clampedRelPos0);
            ...
            if (normalVel > maxVelMag) {
                ...
                normalVel = maxVelMag;
            } else if (normalVel < minVelForProcessing) { return false; }
